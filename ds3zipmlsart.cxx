...
int main(int argc, char * argv[])
{
  ...
  rtk::SetProjectionsReaderFromGgo<ReaderType, args_info_ds3zipmlsart>(reader, args_info);
  ...
  if(args_info.input_given)
    ...
    rtk::SetConstantImageSourceFromGgo<ConstantImageSourceType, args_info_ds3zipmlsart>(constantImageSource, args_info);
...
*/
  ...
  rtk::SartWithZipmlFilter< OutputImageType >::Pointer sart =
	  rtk::SartWithZipmlFilter< OutputImageType >::New();
	sart->SetNumberOfBitsQ00(args_info.nBits_arg[0]);
	sart->SetNumberOfBitsQ01(args_info.nBits_arg[1]);
	sart->SetNumberOfBitsQ02(args_info.nBits_arg[2]);
	sart->SetNumberOfBitsQ03(args_info.nBits_arg[3]);
	sart->SetNumberOfBitsQ04(args_info.nBits_arg[4]);
	sart->SetNumberOfBitsQ05(args_info.nBits_arg[5]);
	sart->SetNumberOfBitsQ06(args_info.nBits_arg[6]);
	sart->SetNumberOfBitsQ07(args_info.nBits_arg[7]);
	std::cout<<"main "<<std::endl;
	std::cout<<args_info.nBits_arg[0]<<' ';
	std::cout<<args_info.nBits_arg[1]<<' ';
	std::cout<<args_info.nBits_arg[2]<<' ';
	std::cout<<args_info.nBits_arg[3]<<' ';
	std::cout<<args_info.nBits_arg[4]<<' ';
	std::cout<<args_info.nBits_arg[5]<<' ';
	std::cout<<args_info.nBits_arg[6]<<' ';
	std::cout<<args_info.nBits_arg[7]<<' ';
	std::cout<<std::endl;

  sart->SetMyVerbose(args_info.MyVerbose_flag);
